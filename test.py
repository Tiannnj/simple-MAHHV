...
f_r_rtr = [0 for _ in range(8)]
r_assign = [4, 2, 0, 0, 5, 1,  2, 2, 2, 2, 2, 2, 4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,]
z = 0
for k in r_assign:
    z = z + k ** 2
f_r_rtr = (sum(r_assign)) ** 2 / (30 * z + 0.0000001)
print(f_r_rtr)
r_assign = [4, 2, 0, 0, 5, 1, 4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,4, 2, 0, 0, 5, 1,]
z = 0
for k in r_assign:
    z = z + k ** 2
f_r_rtr = (sum(r_assign)) ** 2 / (30 * z + 0.0000001)
